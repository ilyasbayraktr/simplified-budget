...
const ExpenseForm = () => {
    ...
    const handleExpense = (e) => {
        e.preventDefault()
        setExpenses([...expenses, { name: expenseName, price: expensePrice, date: expenseDate }]);
        setExpanseName("");
        setExpansePrice("");
        setExpanseDate("");
    ...
    return (
        <form className='flex items-center justify-between gap-1 sm:flex-col' onSubmit={handleExpense}>
